...
Description
-----------
This script runs MedGemma-4B-IT inference on a subset of the IU OpenI chest
...
with the MedGemma-4B-IT vision-language model.
...
Outputs
-------
- evaluation_csvs/IU Dataset/medgemma_preds_test.csv
  Columns:
    - image_id
    - xml_file
    - view
...
# Output CSV path for MedGemma predictions
OUT_CSV = "evaluation_csvs/IU Dataset/medgemma_preds_test.csv"
...
# ===============================================================
# MODEL SETUP: Load MedGemma-4B-IT and Processor
# ===============================================================
...
def generate_report_medgemma(
    ...
    instruction = (
        ...
        "If normal, write a single normal line (e.g., “Lungs clear. Cardiomediastinal silhouette normal. "
        "No pleural effusion or pneumothorax.”). If abnormal, state the key positives only, concise "
        "(e.g., “Feeding tube projects to upper abdomen; bibasilar atelectasis; no pneumothorax or "
        "pleural effusion.”). Start directly with the findings."
    )
